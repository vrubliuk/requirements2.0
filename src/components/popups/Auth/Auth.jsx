...
class Auth extends Component {
  ...
  render() {
    // const errorMessage = this.props.error ? <div className="Auth__Error">Incorrect email address or password</div> : null;
    ...
    return (
      ...
      <div className="Auth">
        ...
        <form className="Auth__form" onSubmit={this.handleSubmit}>
            ...
            {this.props.error && <div className="Auth__error" style={{color}}>Incorrect email address or password</div>}
